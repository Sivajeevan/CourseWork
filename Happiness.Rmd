...
```{r}
X2015 <- read_csv("~/Downloads/archive/2015.csv") %>% mutate(Year = 2015)
X2016 <- read_csv("~/Downloads/archive/2016.csv") %>% mutate(Year = 2016)
X2017 <- read_csv("~/Downloads/archive/2017.csv") %>% mutate(Year = 2017)
X2018 <- read_csv("~/Downloads/archive/2018.csv") %>% mutate(Year = 2018)
X2019 <- read_csv("~/Downloads/archive/2019.csv") %>% mutate(Year = 2019)
X2020 <- read_csv("~/Downloads/archive/2020.csv") %>% mutate(Year = 2020)
X2021 <- read_csv("~/Downloads/archive/2021.csv") %>% mutate(Year = 2021)
X2022 <- read_csv("~/Downloads/archive/2022.csv") %>% mutate(Year = 2022)

list(
  cols2015 = colnames(X2015),
  cols2016 = colnames(X2016),
  cols2017 = colnames(X2017),
  cols2018 = colnames(X2018),
  cols2019 = colnames(X2019),
  cols2020 = colnames(X2020),
  cols2021 = colnames(X2021),
  cols2022 = colnames(X2022)
)

```
```{r}
X2015 <- read_csv("~/Downloads/archive/2015.csv", show_col_types = FALSE) %>%
  transmute(
    Country,
    Region,
...
X2016 <- read_csv("~/Downloads/archive/2016.csv", show_col_types = FALSE) %>%
  transmute(
    Country,
    Region,
    Score = as.numeric(`Happiness Score`),
